...
def x():
    servers = {"google-1": "8.8.8.8", "google-2": "8.8.4.4", "cloudflare-1": "1.1.1.1", "cloudflare-2": "1.0.0.1", "quad9-1": "9.9.9.9",
...
@click.option('--server', '-s', default=default_server, type=click.STRING, help='the nameserver to test', show_default=True, multiple=True)
